...
//XZAssetReader 读取MOV 文件中视频数据
@property (nonatomic, strong) XZAssetReader *reader;
//高速纹理读取缓存区.
...
-(void)setupCCAsset{
    ...
    //注意XZAssetReader 支持MOV/MP4文件都可以
    //1.视频文件路径
    ...
    //2.初始化XZAssetReader
    self.reader = [[XZAssetReader alloc] initWithUrl:url];
