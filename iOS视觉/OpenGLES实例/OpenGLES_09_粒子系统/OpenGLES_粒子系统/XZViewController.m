...
//管理并且绘制所有的粒子对象
@property (strong, nonatomic) XZPointParticleEffect *particleEffect;
...
-(void)viewDidLoad
{
    ...
    //粒子对象
    self.particleEffect = [[XZPointParticleEffect alloc]init];
    ...
    void(^blockA)() = ^{
        ...
        //重力
        self.particleEffect.gravity = XZDefaultGravity;
