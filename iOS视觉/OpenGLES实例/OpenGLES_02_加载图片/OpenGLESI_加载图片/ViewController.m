...
{
    //1.获取纹理图片路径
    NSString *filePath = [[NSBundle mainBundle]pathForResource:@"ziqi" ofType:@"jpg"];
...
-(void)setUpVertexData
{
    ...
    GLfloat vertexData[] = {
        ...
        0.95, -0.5, 0.0f,    1.0f, 0.0f, //右下
        0.95, 0.5, -0.0f,    1.0f, 1.0f, //右上
        -0.95, 0.5, 0.0f,    0.0f, 1.0f, //左上
        
        0.95, -0.5, 0.0f,    1.0f, 0.0f, //右下
        -0.95, 0.5, 0.0f,    0.0f, 1.0f, //左上
        -0.95, -0.5, 0.0f,   0.0f, 0.0f, //左下
    };
